...
void mxcProcessWindowInput()
{
	...
	vec2 mouseDelta = VEC2(midWindowInput.fMouseDeltaX, midWindowInput.fMouseDeltaY);
	mxcWindowInput.mouseUVDelta.vec = mouseDelta.vec / mxcWindowInput.fDimensions.vec;
}
