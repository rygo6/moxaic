...
namespace Moxaic::Vulkan
{
    ...
    public:
        ...
        {
            vkFreeDescriptorSets(k_pDevice->vkDevice,
    ...
    protected:
                                                    ...
                                                    StaticArray<VkDescriptorSetLayoutBinding, N>& bindings)
        {
            ...
            VK_CHK(vkCreateDescriptorSetLayout(device.vkDevice,
                                               &layoutInfo,
                                               VK_ALLOC,
        ...
        MXC_RESULT AllocateDescriptorSet()
        {
            ...
            VK_CHK(vkAllocateDescriptorSets(k_pDevice->vkDevice,
                                            &allocInfo,
                                            &m_VkDescriptorSet));
            return MXC_SUCCESS;
        }
        ...
        void WriteDescriptors(StaticArray<VkWriteDescriptorSet, N>& writes) const
        {
            ...
            VK_CHK_VOID(vkUpdateDescriptorSets(k_pDevice->vkDevice,
                                               writes.size(),
                                               writes.data(),
                                               0,
                                               nullptr));
